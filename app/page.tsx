...
import { Phone, Mail, Globe, MapPin, ArrowRight, ChevronDown, User, Users, Shield, Target } from "lucide-react"

export default function SmartHubPage() {
  const teamMembers = [
    { name: "Kwame Asante", role: "Senior Network Engineer", image: "/professional-black-african-male-network-engineer-p.jpg" },
    { name: "Amina Diallo", role: "Cybersecurity Specialist", image: "/professional-black-african-female-cybersecurity-ex.jpg" },
    { name: "Oluwaseun Adebayo", role: "Cloud Architect", image: "/professional-nigerian-male-cloud-architect-portrai.jpg" },
    { name: "Tendai Chiwenga", role: "Network Infrastructure Lead", image: "/professional-zimbabwean-female-it-infrastructure-l.jpg" },
    { name: "Naledi Molefe", role: "Data Center Specialist", image: "/professional-south-african-female-data-center-spec.jpg" },
    { name: "Chinedu Okonkwo", role: "Wireless Network Engineer", image: "/professional-nigerian-male-wireless-network-engine.jpg" },
    { name: "Fatoumata Diop", role: "Senior Security Architect", image: "/professional-senegalese-female-security-architect-.jpg" },
    { name: "Jabari Johnson", role: "Network Operations Manager", image: "/professional-african-american-male-network-operati.jpg" },
  ]
  ...
  return (
    <div className="min-h-screen bg-white font-sans">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <a href="#experience" className="text-gray-300 hover:text-white text-sm transition">
                Experience
              </a>
      ...
      <section className="relative py-20 px-6 bg-gray-50">
        <div className="absolute top-40 left-8 w-4 h-4 rounded-full bg-blue-400/60 z-10" />
        <div className="absolute top-32 right-6 w-3 h-3 rounded-full bg-emerald-400 z-10" />

        <div className="max-w-7xl mx-auto">
          <div className="flex justify-center mb-4">
            <div className="w-4 h-4 rounded-full bg-purple-400" />
          </div>
          <h2 className="text-4xl font-bold text-center mb-12 text-slate-900">Our Objectives</h2>
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-xl shadow-sm text-center">
              <div className="w-14 h-14 mx-auto mb-4 rounded-full bg-blue-100 flex items-center justify-center">
                <User className="w-7 h-7 text-blue-600" />
              </div>
              <h3 className="text-xl font-semibold text-slate-900 mb-3">Quality Standards</h3>
              <p className="text-gray-500 leading-relaxed">
                The products, services and solutions offered are of highest quality standards achieved through proper
                selection of quality suppliers, creative ideas and highly skilled project personnel.
              </p>
            </div>
            <div className="bg-white p-8 rounded-xl shadow-sm text-center">
              <div className="w-14 h-14 mx-auto mb-4 rounded-full bg-blue-100 flex items-center justify-center">
              ...
              <h3 className="text-xl font-semibold text-slate-900 mb-3">Expert Teams</h3>
              <p className="text-gray-500 leading-relaxed">
                We assemble top-notch individuals and teams with certified, vendor-specific skills for successful
                project execution in telecommunications infrastructure.
              </p>
            </div>
            <div className="bg-white p-8 rounded-xl shadow-sm text-center">
              <div className="w-14 h-14 mx-auto mb-4 rounded-full bg-blue-100 flex items-center justify-center">
              ...
              <h3 className="text-xl font-semibold text-slate-900 mb-3">Robust Solutions</h3>
              <p className="text-gray-500 leading-relaxed">
                We specialize in planning, installation, commissioning, and maintenance of telecommunications
                infrastructure, ensuring robust, secure, and scalable networks.
              </p>
            </div>
          </div>
        </div>
      ...
      {/* Team Section */}
      <section id="team" className="relative py-20 px-6 bg-white">
        <div className="absolute top-32 left-8 w-4 h-4 rounded-full bg-blue-400/60 z-10" />
        <div className="absolute top-48 right-6 w-3 h-3 rounded-full bg-emerald-400 z-10" />
        <div className="absolute bottom-40 left-1/2 w-4 h-4 rounded-full bg-purple-400 z-10" />

        <div className="max-w-7xl mx-auto">
          <p className="text-blue-600 text-sm uppercase tracking-wider text-center mb-2">OUR TEAM</p>
          <h2 className="text-4xl font-bold text-center mb-2 text-slate-900">
            Meet Our{" "}
            <span className="text-emerald-500 underline decoration-emerald-500 underline-offset-4">
              Diverse Experts
      ...
      <section className="relative py-20 px-6 bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <h2 className="text-4xl font-bold text-center mb-8 text-slate-900">Our Qualifications</h2>

          {/* Tabs */}
          <div className="flex justify-center gap-8 mb-8">
            <button className="text-blue-600 font-medium border-b-2 border-blue-600 pb-2">Certifications</button>
            <button className="text-gray-400 font-medium pb-2 hover:text-gray-600 transition">Experience</button>
            <button className="text-gray-400 font-medium pb-2 hover:text-gray-600 transition">Partners</button>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            {[
              ...
              <div key={i} className="bg-white p-6 rounded-xl shadow-sm text-center border border-gray-100">
                <p className="text-3xl font-bold text-blue-600">{qual.count}</p>
                <p className="text-gray-500 text-sm">{qual.label}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section id="experience" className="relative py-20 px-6 bg-white">
        <div className="absolute top-40 left-8 w-4 h-4 rounded-full bg-blue-400/60 z-10" />
        <div className="absolute top-1/2 right-6 w-3 h-3 rounded-full bg-emerald-400 z-10" />
        <div className="absolute bottom-48 left-1/2 w-4 h-4 rounded-full bg-purple-400 z-10" />

        <div className="max-w-4xl mx-auto">
          <h2 className="text-4xl font-bold text-center mb-12 text-slate-900">Project Experience</h2>

          <div className="space-y-6">
            {[
              {
                title: "Ilitha Telecommunications",
                desc: "Provided core network integration and user authentication services. Our work involved ensuring the BNG (Broadband Network Gateway) infrastructure was seamlessly integrated to manage user access and services.",
              },
              {
                title: "Zoom Fiber",
                desc: "Supported backhaul and core network functions. Our role involved systems that interface with public IP resource management (CGNAT), showcasing our experience with the operational support systems used by ISPs.",
              },
              {
                title: "Econet Leshotho",
                desc: "ATN and MW installation link (indoor and outdoor units), Site surveys (TSS,LOS), commissioning and testing details, integration with the core network, maintain and support MW and ATNs.",
              },
              {
                title: "Gauteng Department of Human Settlements",
                desc: "Large-scale network implementation and managed services capability including hands-on installation, configuration, and ongoing maintenance for a multi-vendor environment.",
              },
            ].map((project, i) => (
              <div key={i} className="border-l-4 border-blue-600 pl-6 py-2">
                <h3 className="text-xl font-semibold text-slate-900 mb-2">{project.title}</h3>
                <p className="text-emerald-600 leading-relaxed">{project.desc}</p>
              </div>
            ))}
          </div>
        </div>
